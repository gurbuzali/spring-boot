...
/**
 * {@link SpringBootCondition} used to check if the Hazelcast Jet configuration
 * is available. This either kicks in if a default configuration has been found
 * or if configurable property referring to the resource to use has been set.
 *
 * @author Ali Gurbuz
 * @since 2.3.0
 */
public abstract class HazelcastJetConfigResourceCondition extends ResourceCondition {
	...
	protected HazelcastJetConfigResourceCondition(
			String name,
			String property,
